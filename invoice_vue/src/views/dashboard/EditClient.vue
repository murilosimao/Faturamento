    ...
    <div class="page-add-client">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li><router-link to="/dashboard/clients">Clientes</router-link></li>
                <li><router-link :to="{ name: 'Client', params: { id: client.id }}">{{ client.name }}</router-link></li>
                <li class="is-active"><router-link :to="{ name: 'EditClient', params: { id: client.id }}" aria-current="true">Editar</router-link></li>
            </ul>
        </nav>

        <div class="columns is-multiline">
            <div class="column is-12">
                <h1 class="title">Editar - {{ client.name }}</h1>
            </div>
            ...
            <div class="column is-12">
                <div class="field">
                    <div class="control">
                        <button class="button is-success" @click="submitForm">Salvar Mudanças</button>
                    </div>
                </div>
            </div>
        </div>
